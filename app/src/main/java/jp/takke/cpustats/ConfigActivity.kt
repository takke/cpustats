...
class ConfigActivity : PreferenceActivity() {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        run {
            val pc = PreferenceCategory(this)
            ...
            run {
                ...
                val entryValues = arrayOf(C.CORE_DISTRIBUTION_MODE_2ICONS.toString() + "", C.CORE_DISTRIBUTION_MODE_1ICON_UNSORTED.toString() + "", C.CORE_DISTRIBUTION_MODE_1ICON_SORTED.toString() + "")
